...
$sql = "SELECT * FROM tb_statistik WHERE id_statistik = $id LIMIT 1";
...
<body>
  ...
  <main id="main" class="main">
    <!-- ======= Start Title Section ======= -->
    <div class="pagetitle">
      <h1>Update Statistik</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          <li class="breadcrumb-item"><a href="pages-statistik.php">Statistik</a></li>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" action="pages-statistik-update.php" method="post" enctype="multipart/form-data">
                <div class="col-12">
                  <input type="hidden" name="idStatistik" value="<?php echo $row['id_statistik'] ?>">
                  <label for="tahunAjaran" class="form-label">Tahun Ajaran</label>
                  <input type="number" class="form-control" id="tahunAjaran" name="tahunAjaran" value="<?php echo $row['tahun_ajaran'] ?>" required />
                </div>
                <div class="col-12">
                  <label for="jumlahSiswa" class="form-label">Jumlah Siswa</label>
                  <input type="number" class="form-control" id="jumlahSiswa" name="jumlahSiswa" value="<?php echo $row['jumlah_siswa'] ?>" required />
                </div>
                <div class="col-12">
                  <label for="jumlahGuru" class="form-label">Jumlah Guru</label>
                  <input type="number" class="form-control" id="jumlahGuru" name="jumlahGuru" value="<?php echo $row['jumlah_guru'] ?>" required />
                </div>
                <div class="col-12">
                  <label for="jumlahKelas" class="form-label">Jumlah Kelas</label>
                  <input type="number" class="form-control" id="jumlahKelas" name="jumlahKelas" value="<?php echo $row['jumlah_kelas'] ?>" required />
                </div>
