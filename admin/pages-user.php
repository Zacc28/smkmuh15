        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <p>
                Pada tabel dibawah ini, akan ditampilkan data berupa foto, nama, jabatan, tentang, username dan password dari user dashboard SMK Muh 15.
              </p>
                ...
                <tbody>
                  ...
                  if ($result) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                      ...
                      echo "<td><img src='assets/img/user/" . $row['foto_user'] . "' style='width:75px'></td>";
                      echo "<td>" . $row['nama_user'] . "</td>";
                      echo "<td>" . $row['jabatan_user'] . "</td>";
                      echo "<td>" . $row['tentang_user'] . "</td>";
                      echo "<td>" . $row['username_user'] . "</td>";
                      echo "<td>" . $row['password_user'] . "</td>";
                      echo "<td><a href='pages-user-edit.php?id=" . $row['id_user'] . "'><button type='button' class='btn btn-warning'><i class='bi bi-pencil'></i></button></a> | 
                          <a href='pages-user-delete.php?id=" . $row['id_user'] . "'><button type='button' class='btn btn-danger'><i class='bi bi-trash'></i></button></a></td>";
                      echo "</tr>";
                      $no++;
                    }
        ...
        <div class="col-lg-12" id="tambah-data">
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" action="pages-user-create.php" method="post" enctype="multipart/form-data">
                <div class="col-md-4">
                ...
                <div class="col-12">
                  ...
                  <textarea class="form-control" style="height: 100px" id="tentangUser" name="tentangUser" required></textarea>
                </div>
