...
$sql = "SELECT * FROM tb_user WHERE id_user = $id LIMIT 1";
        ...
        <div class="col-lg-12" id="tambah-data">
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" action="pages-user-update.php" method="post" enctype="multipart/form-data">
                <div class="col-md-4">
                  <input type="hidden" name="idUser" value="<?php echo $row['id_user'] ?>">
                  <label for="namaUser" class="form-label">Nama Lengkap</label>
                  <input type="text" class="form-control" id="namaUser" name="namaUser" value="<?php echo $row['nama_user'] ?>" required />
                </div>
                <div class="col-4">
                  <label for="jabatanUser" class="form-label">Jabatan User</label>
                  <select class="form-select" id="jabatanUser" name="jabatanUser" aria-label="Default select example" required>
                    <option selected disabled hidden>Pilih kategori</option>
                    <option value="admin" <?php echo ($row['jabatan_user'] === "admin") ? 'selected' : ''; ?>>Admin</option>
                    <option value="editor" <?php echo ($row['jabatan_user'] === "editor") ? 'selected' : ''; ?>>Editor</option>
                  </select>
                </div>
                <div class="col-md-4">
                  ...
                  <input type="hidden" name="hiddenImage" value="<?php echo $row["foto_user"] ?>">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" id="usernameUser" name="usernameUser" value="<?php echo $row['username_user'] ?>" required />
                </div>
                <div class="col-md-6">
                  <label for="passwordUser" class="form-label">Password</label>
                  <input type="text" class="form-control" id="passwordUser" name="passwordUser" value="<?php echo $row['password_user'] ?>" required />
                </div>
                <div class="col-12">
                  <label for="tentangUser" class="form-label">Tentang Saya</label>
                  <textarea class="form-control" style="height: 100px" id="tentangUser" name="tentangUser" required><?php echo $row['tentang_user'] ?></textarea>
                </div>
