...
$sql = "SELECT * FROM tb_partnership WHERE id_partnership = $id LIMIT 1";
...
<body>
  ...
  <main id="main" class="main">
    <!-- ======= Start Title Section ======= -->
    <div class="pagetitle">
      <h1>Update Partnership</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          <li class="breadcrumb-item"><a href="pages-partnership.php">Partnership</a></li>
          <li class="breadcrumb-item active">Update Partnership</li>
        </ol>
      </nav>
    </div>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" action="pages-partnership-update.php" method="post" enctype="multipart/form-data">
                <div class="col-12">
                  <input type="hidden" name="idPartnership" value="<?php echo $row['id_partnership'] ?>">
                  <label for="namaPartnership" class="form-label">Nama Partnership</label>
                  <input type="text" class="form-control" id="namaPartnership" name="namaPartnership" value="<?php echo $row['nama_partnership'] ?>" required />
                </div>
                <div class="col-12">
                  ...
                  <input type="hidden" name="hiddenImage" value="<?php echo $row["logo_partnership"] ?>">
                </div>
