...
<head>
  ...
  <title>Partnership - NiceAdmin</title>
...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="pages-partnership.php">
    ...
    <section class="section">
      <div class="row">
        ...
        <div class="col-lg-8">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Daftar Partnership</h5>
              <p>
                Pada tabel dibawah ini, akan ditampilkan data berupa logo, dan nama dari instansi yang bekerja sama dengan SMK Muh 15.
              </p>
                ...
                <tbody>
                  ...
                  if ($result) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                      ...
                      echo "<td><img src='assets/img/partnership/" . $row['logo_partnership'] . "' style='width:75px'></td>";
                      echo "<td>" . $row['nama_partnership'] . "</td>";
                      echo "<td><a href='pages-partnership-edit.php?id=" . $row['id_partnership'] . "'><button type='button' class='btn btn-warning'><i class='bi bi-pencil'></i></button></a> | 
                          <a href='pages-partnership-delete.php?id=" . $row['id_partnership'] . "'><button type='button' class='btn btn-danger'><i class='bi bi-trash'></i></button></a></td>";
                      echo "</tr>";
                      $no++;
                    }
        ...
        <div class="col-lg-4">
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" action="pages-partnership-create.php" method="post" enctype="multipart/form-data">
                <div class="col-12">
                  <label for="namaPartnership" class="form-label">Nama Partnership</label>
                  <input type="text" class="form-control" id="namaPartnership" name="namaPartnership" required />
                </div>
                <div class="col-12">
                  ...
                  <p class="lh-2 fst-italic pt-2 mb-0 text-muted" style="font-size: 13px">
                    Catatan: Unggah foto dengan orientasi landscape untuk hasil terbaik.
                  </p>
                </div>
