...
$sql = "SELECT * FROM tb_program WHERE id_program = $id LIMIT 1";
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="pages-program.php">Program</a></li>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" action="pages-program-update.php" method="post" enctype="multipart/form-data">
                <div class="col-12">
                  <input type="hidden" name="idProgram" value="<?php echo $row['id_program'] ?>">
                  <label for="namaProgram" class="form-label">Nama Program</label>
                  <input type="text" class="form-control" id="namaProgram" name="namaProgram" value="<?php echo $row['nama_program'] ?>" required />
                </div>
                <div class="col-12">
                  <label for="IconProgram" class="form-label">Icon Program</label>
                  <input type="text" class="form-control" id="iconProgram" name="iconProgram" value="<?php echo $row['icon_program'] ?>" required />
                </div>
                <div class="col-12">
                  <label for="deskripsiProgram" class="form-label">Deskripsi Program</label>
                  <textarea class="form-control" style="height: 100px" id="deskripsiProgram" name="deskripsiProgram" required><?php echo $row['deskripsi_program'] ?></textarea>
                </div>
