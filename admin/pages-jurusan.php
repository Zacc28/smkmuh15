        ...
        <div class="col-lg-8">
          <div class="card">
            <div class="card-body">
              ...
              <p>
                Pada tabel dibawah ini, akan ditampilkan data berupa nama jurusan yang tersedia di SMK Muh 15.
              </p>
                ...
                <tbody>
                  ...
                  if ($result) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                      ...
                      echo "<td>" . $row['icon_jurusan'] . "</td>";
                      echo "<td>" . $row['nama_jurusan'] . "</td>";
                      echo "<td><a href='pages-jurusan-edit.php?id=" . $row['id_jurusan'] . "'><button type='button' class='btn btn-warning'><i class='bi bi-pencil'></i></button></a> | 
                          <a href='pages-jurusan-delete.php?id=" . $row['id_jurusan'] . "'><button type='button' class='btn btn-danger'><i class='bi bi-trash'></i></button></a></td>";
                      echo "</tr>";
                      $no++;
                    }
        ...
        <div class="col-lg-4">
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" action="pages-jurusan-create.php" method="post" enctype="multipart/form-data">
                <div class="col-12">
                  <label for="iconJurusan" class="form-label">Icon Jurusan</label>
                  <input type="text" class="form-control" id="iconJurusan" name="iconJurusan" required />
                </div>
                <div class="col-12">
