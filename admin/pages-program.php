...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="pages-program.php">
        ...
        <div class="col-lg-8">
          <div class="card">
            <div class="card-body">
              ...
              <p>
                Pada tabel dibawah ini, akan ditampilkan data berupa nama program unggulan dan deskripsinya yang tersedia di SMK Muh 15.
              </p>
                ...
                <tbody>
                  ...
                  if ($result) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                      ...
                      echo "<td>" . $row['icon_program'] . "</td>";

                      // Batasi deskripsi menjadi 100 karakter tanpa memotong kata
                      $deskripsi = $row['deskripsi_program'];
                      if (strlen($deskripsi) > 100) {
                        $deskripsi = substr($deskripsi, 0, 100); // Ambil 100 karakter pertama
                        $lastSpace = strrpos($deskripsi, ' '); // Temukan posisi spasi terakhir
                        $deskripsi = substr($deskripsi, 0, $lastSpace); // Potong hingga spasi terakhir
                        $deskripsi .= '...';
                      }

                      echo "<td>" . $deskripsi . "</td>";

                      echo "<td><a href='pages-program-edit.php?id=" . $row['id_program'] . "'><button type='button' class='btn btn-warning'><i class='bi bi-pencil'></i></button></a> | 
                        <a href='pages-program-delete.php?id=" . $row['id_program'] . "'><button type='button' class='btn btn-danger'><i class='bi bi-trash'></i></button></a></td>";
                      echo "</tr>";
                      $no++;
                    }
        ...
        <div class="col-lg-4">
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" action="pages-program-create.php" method="post" enctype="multipart/form-data">
                <div class="col-12">
                ...
                <div class="col-12">
                  <label for="iconProgram" class="form-label">Icon Program</label>
                  <input type="text" class="form-control" id="iconProgram" name="iconProgram" required />
                </div>
                <div class="col-12">
                  <label for="deskripsiProgram" class="form-label">Deskripsi Program</label>
                  <textarea class="form-control" style="height: 100px" id="deskripsiProgram" name="deskripsiProgram" required></textarea>
                </div>
