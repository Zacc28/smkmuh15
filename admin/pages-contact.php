    ...
    <section class="section">
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Daftar Kontak</h5>
              <p>
                Pada tabel dibawah ini, akan ditampilkan data berupa email, nomor telepon dan alamat dari SMK Muh 15.
              </p>
                ...
                <tbody>
                  ...
                  if ($result) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                      ...
                      echo "<td>" . $row['telp_contact'] . "</td>";
                      echo "<td>" . $row['alamat_contact'] . "</td>";
                      echo "<td><a href='pages-contact-edit.php?id=" . $row['id_contact'] . "'><button type='button' class='btn btn-warning'><i class='bi bi-pencil'></i></button></a> | 
                          <a href='pages-contact-delete.php?id=" . $row['id_contact'] . "'><button type='button' class='btn btn-danger'><i class='bi bi-trash'></i></button></a></td>";
                      echo "</tr>";
                      $no++;
                    }
                    mysqli_free_result($result);
                  } else {
                    header("location:pages-contact.php?pesan=database_error");
                  }
