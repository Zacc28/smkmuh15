        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <p>
                Pada tabel dibawah ini, akan ditampilkan data berupa pertanyaan yang sering diajukan kepada SMK Muh 15.
              </p>
                ...
                <tbody>
                  ...
                  if ($result) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                      ...
                      echo "<td>" . $row['question_faq'] . "</td>";
                      echo "<td>" . $row['answer_faq'] . "</td>";
                      echo "<td><a href='pages-faq-edit.php?id=" . $row['id_faq'] . "'><button type='button' class='btn btn-warning'><i class='bi bi-pencil'></i></button></a> | 
                          <a href='pages-faq-delete.php?id=" . $row['id_faq'] . "'><button type='button' class='btn btn-danger'><i class='bi bi-trash'></i></button></a></td>";
                      echo "</tr>";
                      $no++;
                    }
                    mysqli_free_result($result);
                  } else {
                    header("location:pages-faq.php?pesan=database_error");
                  }
