...
$sql = "SELECT * FROM tb_contact WHERE id_contact = $id LIMIT 1";
...
<head>
  ...
  <title>Kontak Kami - NiceAdmin</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="pages-contact.php">Kontak Kami</a></li>
          <li class="breadcrumb-item active">Update Kontak</li>
        </ol>
      </nav>
    </div>
    <!-- End Title Section -->
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" action="pages-contact-update.php" method="post" enctype="multipart/form-data">
                <div class="col-12">
                  <input type="hidden" name="idContact" value="<?php echo $row['id_contact'] ?>">
                  <label for="emailContact" class="form-label">Email Sekolah</label>
                  <input type="text" class="form-control" id="emailContact" name="emailContact" value="<?php echo $row['email_contact'] ?>" required />
                </div>
                <div class="col-12">
                  <label for="telpContact" class="form-label">No. Telepon</label>
                  <input type="text" class="form-control" id="telpContact" name="telpContact" value="<?php echo $row['telp_contact'] ?>" required />
                </div>
                <div class="col-12">
                  <label for="alamatContact" class="form-label">Alamat Sekolah</label>
                  <textarea class="form-control" style="height: 100px" id="alamatContact" name="alamatContact" required><?php echo $row['alamat_contact'] ?></textarea>
                </div>
