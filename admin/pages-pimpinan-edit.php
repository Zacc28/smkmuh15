...
$sql = "SELECT * FROM tb_pimpinan WHERE id_pimpinan = $id LIMIT 1";
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="pages-pimpinan.php">Pimpinan</a></li>
          <li class="breadcrumb-item active">Update Pimpinan</li>
        </ol>
      </nav>
    </div>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" action="pages-pimpinan-update.php" method="post" enctype="multipart/form-data">
                <div class="col-md-4">
                  <input type="hidden" name="idPimpinan" value="<?php echo $row['id_pimpinan'] ?>">
                  <label for="namaPimpinan" class="form-label">Nama Lengkap</label>
                  <input type="text" class="form-control" id="namaPimpinan" name="namaPimpinan" value="<?php echo $row['nama_pimpinan'] ?>" required />
                </div>
                <div class="col-md-4">
                  <label for="jabatanPimpinan" class="form-label">Jabatan</label>
                  <input type="text" class="form-control" id="jabatanPimpinan" name="jabatanPimpinan" value="<?php echo $row['jabatan_pimpinan'] ?>" required />
                </div>
                <div class="col-md-4">
                  ...
                  <input type="hidden" name="hiddenImage" value="<?php echo $row["foto_pimpinan"] ?>">
                ...
                <div class="col-md-6">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" id="twitter_pimpinan" name="twitterPimpinan" aria-describedby="twitter_pimpinan" placeholder="@username" value="<?php echo $row['twitter_pimpinan'] ?>">
                  </div>
                </div>
                <div class="col-md-6">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" id="facebook_pimpinan" name="facebookPimpinan" aria-describedby="facebook_pimpinan" placeholder="username" value="<?php echo $row['facebook_pimpinan'] ?>">
                  </div>
                </div>
                <div class="col-md-6">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" id="instagram_pimpinan" name="instagramPimpinan" aria-describedby="instagram_pimpinan" placeholder="username" value="<?php echo $row['instagram_pimpinan'] ?>">
                  </div>
                </div>
                <div class="col-md-6">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" id="linkedin_pimpinan" name="linkedinPimpinan" aria-describedby="linkedin_pimpinan" placeholder="username" value="<?php echo $row['linkedin_pimpinan'] ?>">
                  </div>
                </div>
