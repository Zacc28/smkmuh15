    ...
    <section class="section">
      <div class="row">
        ...
        <div class="col-lg-8">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Daftar Sarana Prasarana</h5>
              <p>
                Pada tabel dibawah ini, akan ditampilkan data berupa foto, nama, deskripsi dan kategori dari sarana prasarana SMK Muh 15.
              </p>
                ...
                <tbody>
                  ...
                  if ($result) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                      ...
                      echo "<td><img src='assets/img/sarpras/" . $row['foto_sarpras'] . "' style='width:75px'></td>";
                      echo "<td>" . $row['nama_sarpras'] . "</td>";
                      echo "<td>" . $row['deskripsi_sarpras'] . "</td>";
                      echo "<td>" . $row['kategori_sarpras'] . "</td>";
                      echo "<td><a href='pages-sarpras-edit.php?id=" . $row['id_sarpras'] . "'><button type='button' class='btn btn-warning'><i class='bi bi-pencil'></i></button></a> | 
                          <a href='pages-sarpras-delete.php?id=" . $row['id_sarpras'] . "'><button type='button' class='btn btn-danger'><i class='bi bi-trash'></i></button></a></td>";
                      echo "</tr>";
                      $no++;
                    }
        ...
        <div class="col-lg-4">
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" action="pages-sarpras-create.php" method="post" enctype="multipart/form-data">
                <div class="col-12">
                  <label for="namaSarpras" class="form-label">Nama Sarpras</label>
                  <input type="text" class="form-control" id="namaSarpras" name="namaSarpras" required />
                </div>
                <div class="col-12">
                ...
                <div class="col-12">
                  ...
                  <textarea class="form-control" style="height: 100px" id="deskripsiSarpras" name="deskripsiSarpras" required></textarea>
                </div>
                <div class="col-12">
