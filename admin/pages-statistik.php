...
<head>
  ...
  <title>Statistik - NiceAdmin</title>
...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="pages-statistik.php">
    ...
    <section class="section">
      <div class="row">
        ...
        <div class="col-lg-8">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Statistik Sekolah</h5>
              <p>
                Pada tabel dibawah ini, akan ditampilkan data berupa tahun angkatan, jumlah siswa, jumlah guru dan jumlah kelas yang tersedia di SMK Muh 15.
              </p>
                ...
                <tbody>
                  ...
                  if ($result) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                      ...
                      echo "<td>" . $row['jumlah_guru'] . "</td>";
                      echo "<td>" . $row['jumlah_kelas'] . "</td>";
                      echo "<td><a href='pages-statistik-edit.php?id=" . $row['id_statistik'] . "'><button type='button' class='btn btn-warning'><i class='bi bi-pencil'></i></button></a> | 
                          <a href='pages-statistik-delete.php?id=" . $row['id_statistik'] . "'><button type='button' class='btn btn-danger'><i class='bi bi-trash'></i></button></a></td>";
                      echo "</tr>";
                      $no++;
                    }
        ...
        <div class="col-lg-4">
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" action="pages-statistik-create.php" method="post" enctype="multipart/form-data">
                <div class="col-12">
                  <label for="tahunAjaran" class="form-label">Tahun Ajaran</label>
                  <input type="number" class="form-control" id="tahunAjaran" name="tahunAjaran" required />
                </div>
                <div class="col-12">
                ...
                <div class="col-12">
                  ...
                  <input type="number" class="form-control" id="jumlahGuru" name="jumlahGuru" required />
                </div>
                <div class="col-12">
                  <label for="jumlahKelas" class="form-label">Jumlah Kelas</label>
                  <input type="number" class="form-control" id="jumlahKelas" name="jumlahKelas" required />
                </div>
