...
$sql = "SELECT * FROM tb_testimoni WHERE id_alumni = $id LIMIT 1";
...
<head>
  ...
  <title>Testimoni Alumni - NiceAdmin</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="pages-testimoni.php">Testimoni</a></li>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" action="pages-testimoni-update.php" method="post" enctype="multipart/form-data">
                <div class="col-12">
                  <input type="hidden" name="idAlumni" value="<?php echo $row['id_alumni'] ?>">
                  <label for="namaAlumni" class="form-label">Nama Lengkap</label>
                  <input type="text" class="form-control" id="namaAlumni" name="namaAlumni" value="<?php echo $row['nama_alumni'] ?>" required />
                </div>
                <div class="col-12">
                  <label for="profesiAlumni" class="form-label">Pekerjaan</label>
                  <input type="text" class="form-control" id="profesiAlumni" name="profesiAlumni" value="<?php echo $row['profesi_alumni'] ?>" required />
                </div>
                <div class="col-12">
                  ...
                  <input type="hidden" name="hiddenImage" value="<?php echo $row["foto_alumni"] ?>">
                </div>
                <div class="col-12">
                  <label for="komentarAlumni" class="form-label">Komentar</label>
                  <textarea class="form-control" style="height: 100px" id="komentarAlumni" name="komentarAlumni" required><?php echo $row['komentar_alumni'] ?></textarea>
                </div>
